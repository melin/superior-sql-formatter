...
import com.github.melin.superior.sql.formatter.antlr4.ParseErrorListener
import com.github.melin.superior.sql.formatter.antlr4.ParseException
import com.github.melin.superior.sql.formatter.antlr4.SparkSqlPostProcessor
import com.github.melin.superior.sql.formatter.antlr4.UpperCaseCharStream
...
object SparkSelectSqlFormatter {
    ...
    fun formatSql(sql: String): String? {
        ...
        val charStream = UpperCaseCharStream(CharStreams.fromString(trimSql))
